...
{
public:
	MyRoom_title(MyKey* key, MyMouse* mouse, LPDIRECT3D9 g_pD3D, LPDIRECT3DDEVICE9 g_pDevice,
	...
	: MyRoom(key, mouse, g_pD3D, g_pDevice, g_pSprite, g_pSpriteRender, g_pTexture, g_pRenderTexture, g_pRenderSurface)
	{
		onInit();
	}
	void onInit();
